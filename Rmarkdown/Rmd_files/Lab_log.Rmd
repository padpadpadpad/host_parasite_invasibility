...
- Phage spot tests for each of 4 phage on each clone
    - 20 clones per replicate
    - 80 plates
    - for controls do ancestral phage, their own phage (should be 0) and two other random phages (37 and 42)
- Plate out ancestral to isolate phage
- Re-plate phage from T~2~ 
    - 1, 10, 42 (10^-2^ and 10^-3^)
    - 37 (10^-1^ and 10^-2^)